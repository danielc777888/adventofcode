...
solve :: String -> String
solve = show . maximum . map snd . positions . hits . simulate . initials (0, 0) . target . head . lines
...
missed :: Position -> Area -> Velocity -> Bool
missed _ (_, (x2, y2)) (x, y) = x > x2 || y > y2
